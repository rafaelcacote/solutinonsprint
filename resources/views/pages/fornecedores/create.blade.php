...
@section('content')
    <x-common.page-breadcrumb pageTitle="Novo Fornecedor" icon="ecommerce" />
    ...
    <div class="space-y-6">
        <x-common.component-card title="Criar Fornecedor">
            <form method="POST" action="{{ route('fornecedores.store') }}" class="space-y-5">
                @csrf
