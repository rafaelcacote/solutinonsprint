...
@section('content')
    <x-common.page-breadcrumb pageTitle="Nova categoria de despesa" icon="forms" />
    ...
    <div class="space-y-6">
        <x-common.component-card title="Criar categoria de despesa">
            <form method="POST" action="{{ route('categorias-despesa.store') }}" class="space-y-5">
                @csrf
