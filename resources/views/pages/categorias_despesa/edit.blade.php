...
@section('content')
    <x-common.page-breadcrumb pageTitle="Editar categoria de despesa" icon="forms" />
    ...
    <div class="space-y-6">
        <x-common.component-card title="Editar categoria de despesa">
            <form method="POST" action="{{ route('categorias-despesa.update', $categoriaDespesa) }}" class="space-y-5">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div>
                        ...
                        <input
                            type="text"
                            name="nome"
                            value="{{ old('nome', $categoriaDespesa->nome) }}"
                    ...
                    <div class="flex items-end">
                        <label class="inline-flex items-center gap-3 text-sm font-medium text-gray-700 dark:text-gray-400">
                            ...
                            <input
                                ...
                                name="ativo"
                                value="1"
                                @checked(old('ativo', (string) (int) $categoriaDespesa->ativo) === '1')
                ...
                <div>
                    ...
                    <textarea
                        name="descricao"
                        rows="4"
                        placeholder="Detalhes da categoria (opcional)"
                    ...
                    >{{ old('descricao', $categoriaDespesa->descricao) }}</textarea>
                    @error('descricao')
                        <p class="mt-1.5 text-sm text-red-500 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
