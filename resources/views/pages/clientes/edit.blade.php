...
@section('content')
    <x-common.page-breadcrumb pageTitle="Editar Cliente" icon="user-profile" />
    ...
    <div class="space-y-6">
        <x-common.component-card title="Editar Cliente">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('cpf_cnpj') border-red-500 focus:border-red-500 dark:border-red-500 @enderror"
                        />
                        @error('cpf_cnpj')
                            <p class="mt-1.5 text-sm text-red-500 dark:text-red-400">{{ $message }}</p>
                        @enderror
