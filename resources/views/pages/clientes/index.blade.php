...
@section('content')
    <x-common.page-breadcrumb pageTitle="Clientes" icon="user-profile" />
    ...
    <div
        class="space-y-6"
        x-data="{ deleteAction: '', deleteClienteNome: '' }"
    >
        <x-common.component-card title="Gerenciar Clientes" desc="">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <form method="GET" action="{{ route('clientes.index') }}" class="flex w-full gap-3 sm:w-auto">
                    <input
                        type="text"
                        name="search"
                                    ...
                                    <td class="px-4 sm:px-6 py-3.5">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <button
                                                ...
                                                @click="
                                                    deleteAction = {{ Js::from(route('clientes.destroy', $cliente)) }};
                                                    deleteClienteNome = {{ Js::from($cliente->nome) }};
                                                    $dispatch('open-delete-cliente-modal');
                                                "
                                            >
                                                <svg
                    ...
                    <div class="flex items-center justify-between gap-2 px-0 py-0 sm:justify-normal">
                        <a
                            ...
                            @class([
                                ...
                                'border-gray-300 bg-white text-gray-700 hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200' => $clientes->onFirstPage() === false,
                                'pointer-events-none border-gray-200 bg-gray-100 text-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-600' => $clientes->onFirstPage(),
                            ])
                        >
                            <span>
                                ...
                                <li>
                                    <a
                                        ...
                                        @class([
                                            ...
                                            'bg-brand-500 text-white hover:bg-brand-500 hover:text-white' => $page === $clientes->currentPage(),
                                            'text-gray-700 hover:bg-brand-500 hover:text-white dark:text-gray-400 dark:hover:text-white' => $page !== $clientes->currentPage(),
                                        ])
                                    >
                                        {{ $page }}
                                    </a>
                        ...
                        <a
                            ...
                            @class([
                                'flex items-center gap-2 rounded-lg border p-2 sm:p-2.5 shadow-theme-xs',
                                'border-gray-300 bg-white text-gray-700 hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200' => $clientes->hasMorePages(),
                                'pointer-events-none border-gray-200 bg-gray-100 text-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-600' => $clientes->hasMorePages() === false,
                            ])
                        >
                            <span>
                                <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <x-ui.modal @open-delete-cliente-modal.window="open = true" :isOpen="false" class="max-w-[520px]">
            <div class="w-full p-6 sm:p-8">
                <h4 class="text-xl font-semibold text-gray-800 dark:text-white/90">
                    Confirmar exclusão
                </h4>
                <p class="mt-3 text-sm text-gray-500 dark:text-gray-400">
                    Tem certeza que deseja excluir o cliente <span class="font-medium text-gray-700 dark:text-gray-300"
                        x-text="deleteClienteNome"></span>?
                </p>
