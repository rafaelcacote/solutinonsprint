...
@section('content')
    <x-common.page-breadcrumb pageTitle="Nova forma de pagamento" icon="forms" />
    ...
    <div class="space-y-6">
        <x-common.component-card title="Criar forma de pagamento">
            <form method="POST" action="{{ route('formas-pagamento.store') }}" class="space-y-5">
                @csrf
