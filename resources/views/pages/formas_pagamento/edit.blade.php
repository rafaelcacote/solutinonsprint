...
@section('content')
    <x-common.page-breadcrumb pageTitle="Editar forma de pagamento" icon="forms" />
    ...
    <div class="space-y-6">
        <x-common.component-card title="Editar forma de pagamento">
            <form method="POST" action="{{ route('formas-pagamento.update', $formaPagamento) }}" class="space-y-5">
                @csrf
                @method('PUT')
                        ...
                        <div class="relative z-20 bg-transparent">
                            ...
                            >
                                ...
                                @foreach (\App\Models\FormaPagamento::TIPOS_LABELS as $valor => $rotulo)
                                    <option value="{{ $valor }}" @selected(old('tipo', $formaPagamento->tipo) === $valor)>{{ $rotulo }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="flex items-end md:col-span-2">
                        <label class="inline-flex items-center gap-3 text-sm font-medium text-gray-700 dark:text-gray-400">
                            ...
                            <input
                                ...
                                name="ativo"
                                value="1"
                                @checked(old('ativo', (string) (int) $formaPagamento->ativo) === '1')
