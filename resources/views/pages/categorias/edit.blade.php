...
@section('content')
    <x-common.page-breadcrumb pageTitle="Editar Categoria" icon="forms" />
    ...
    <div class="space-y-6">
        <x-common.component-card title="Editar Categoria">
                    ...
                    <div class="flex items-end">
                        <label class="inline-flex items-center gap-3 text-sm font-medium text-gray-700 dark:text-gray-400">
                            ...
                            <input
                                ...
                                name="ativo"
                                value="1"
                                @checked(old('ativo', (string) (int) $categoria->ativo) === '1')
